...
public class b_tileDetails_c_i_intraExpanded extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_c_i_intraExpanded() throws ClassNotFoundException {
