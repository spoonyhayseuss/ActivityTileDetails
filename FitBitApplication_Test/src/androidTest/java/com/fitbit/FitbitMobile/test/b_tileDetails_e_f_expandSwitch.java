...
public class b_tileDetails_e_f_expandSwitch extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_e_f_expandSwitch() throws ClassNotFoundException {
