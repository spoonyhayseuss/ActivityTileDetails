...
public class b_tileDetails_b_k_expandSwitch extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_b_k_expandSwitch() throws ClassNotFoundException {
