...
public class b_tileDetails_e_h_intraPastDay extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_e_h_intraPastDay() throws ClassNotFoundException {
