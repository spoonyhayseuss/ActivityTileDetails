...
public class b_tileDetails_d_i_intraExpanded extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_d_i_intraExpanded() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.sleep(500);
        solo.clickOnText(java.util.regex.Pattern.quote("Floors Climbed"));
