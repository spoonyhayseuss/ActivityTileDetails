...
public class b_tileDetails_a_b_tipShown extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_a_b_tipShown() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("Try hitting 10,000 steps per day."));
