...
public class b_tileDetails_c_k_removeTip extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_c_k_removeTip() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickLongOnText(java.util.regex.Pattern.quote("Did you know? You burn calories"));
