...
public class b_tileDetails_b_i_expand3month extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_b_i_expand3month() throws ClassNotFoundException {
