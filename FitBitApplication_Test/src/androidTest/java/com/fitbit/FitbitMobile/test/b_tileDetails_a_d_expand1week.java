...
public class b_tileDetails_a_d_expand1week extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_a_d_expand1week() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnText(java.util.regex.Pattern.quote("steps"));
        solo.clickOnText(java.util.regex.Pattern.quote("Daily Avg:"));
