...
public class b_tileDetails_b_n_intraExpanded extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public b_tileDetails_b_n_intraExpanded() throws ClassNotFoundException {
